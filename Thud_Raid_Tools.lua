...
announceBtn:SetWidth(110); announceBtn:SetHeight(22)
announceBtn:SetPoint("BOTTOMRIGHT", mainFrame, "BOTTOMRIGHT", -10, 15)
THUD_Style(announceBtn, "Announce Buffs")
